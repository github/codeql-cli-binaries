...
'#'['O'B'J']'='';'' 'new'=''=' '"'$'"'Obj=':'' :
'#'New :Feat.-remix.yml :m ''
''#'Nature'' ':- 'Query packs created by `codeql pack create`, `codeql pack bundle`, and `codeql pack release` now
  c'ontain precompiled queries in a new format that aims to be compatible with future (and, to a
  'ertain extent, past) releases of the CodeQL CLI. Previously the precompiled queries were in a
...
- 'The `codeql database init` command now accepts a PAT that allows you to download queries from
  ...
  'repositories :dipatch :worksflow_/call-on :dispatch''
  'Return; 'Run '' '"'' :
  '- 'codeql-test/my-private-repository'@main/master/README.FRMD/README.MD :
